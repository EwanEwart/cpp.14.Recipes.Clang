...
#undef REFERENCE
  ...
  Car aCar{};
  ptrVehicle = &aCar; // down cast, automatic
  auto number_of_wheels = ptrVehicle->GetNumberOfWheels();
  cout << "1.2 A car has " << number_of_wheels << " wheels." << endl;

  Motorcycle aMotorcycle;
  ptrVehicle = &aMotorcycle; // down cast, automatic
  cout << "1.3 A motorcycle has " << ptrVehicle->GetNumberOfWheels() << " wheels." << endl;

  Tricycle aTricycle;
  ptrVehicle = &aTricycle;
  cout << "1.4 A tricycle has " << ptrVehicle->GetNumberOfWheels() << " wheels." << endl;
