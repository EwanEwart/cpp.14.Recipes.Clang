...
*/
    ...
    std::string DBG_STRING_LITERAL{ "DBG_STRING_LITERAL is defined for DEBUG only"s };
#endif
...
#if !defined(NDEBUG) // if DEBUG build: string literls will be included into the string table of the executable and can therefore be used
